...
export const MODEL_PROVIDERS: Record<string, ProviderConfig> = {
  ...
  "zhipuai": {
    ...
    models: [
      ...
      { id: "glm-4.7", name: "GLM-4.7 (Paid)" },
      { id: "glm-4.6", name: "GLM-4.6 (Paid)" },
      { id: "glm-4.5", name: "GLM-4.5 (Paid)" },
      { id: "glm-4.5-air", name: "GLM-4.5 Air (Paid)" },
      { id: "glm-4-plus", name: "GLM-4 Plus (Paid)" },
      { id: "glm-4-air", name: "GLM-4 Air (Paid)" },
    ],
